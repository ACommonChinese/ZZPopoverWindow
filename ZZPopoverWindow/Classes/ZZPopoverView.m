...
- (void)setOrigin {
    ...
    switch (popoverPosition) {
        ...
        case ZZPopoverPositionDown: {
            ...
            self.arrowShowPoint      = CGPointMake(CGRectGetMidX(self.atViewFrame), CGRectGetMaxY(self.atViewFrame) + self.margin);
        ...
        case ZZPopoverPositionUp: {
            ...
            // reset popView's frame
            self.arrowShowPoint   = CGPointMake(CGRectGetMidX(self.atViewFrame), CGRectGetMinY(self.atViewFrame) - self.margin);
            CGRect popViewFrame   = self.frame;
        ...
        case ZZPopoverPositionRight: {
            ...
            // reset popView's frame
            self.arrowShowPoint   = CGPointMake(CGRectGetMaxX(self.atViewFrame) + self.margin, CGRectGetMidY(self.atViewFrame));
            CGRect popViewFrame   = self.frame;
        ...
        case ZZPopoverPositionLeft: {
            ...
            // reset popView's frame
            self.arrowShowPoint = CGPointMake(CGRectGetMinX(self.atViewFrame)-self.margin, CGRectGetMidY(self.atViewFrame));
            CGRect popViewFrame = self.frame;
